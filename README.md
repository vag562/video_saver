...
- Файлы до 1900 MB отправляются в Telegram, файлы больше 1900 MB выдаются временной ссылкой на 3 часа.
...
- `worker` — RQ worker, скачивание и обработка через `yt-dlp`/`ffmpeg`.
