...
Бот не показывает пользователю task id, внутренние статусы (`pending`, `downloading`, `ready`) или технические названия инструментов. Основной сценарий:
...
✅ Скачано при помощи: @savefromyttt_bot
```
